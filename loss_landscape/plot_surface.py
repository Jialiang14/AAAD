...
if __name__ == '__main__':
    ...
    parser.add_argument('--datapath', default='/mnt/jfs/sunjialiang/data', metavar='DIR', help='path to the dataset')
    parser.add_argument('--raw_data', action='store_true', default=False, help='no data preprocessing')
    parser.add_argument('--data_split', default=1000, type=int, help='the number of splits for the dataloader')
    ...
    parser.add_argument('--model_file', default='/mnt/jfs/sunjialiang/AAAD/retrain/standard_train/trained_model/ResNet18-20230404-100449/weights.pt', help='path to the trained model file')
    ...
    parser.add_argument('--x', default='-1:1:50', help='A string with format xmin:x_max:xnum')
    parser.add_argument('--y', default='-1:1:50', help='A string with format ymin:ymax:ynum')
