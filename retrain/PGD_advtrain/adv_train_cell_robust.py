...
from retrain.robust_model import RobustNetworkCIFAR as Network
...
parser.add_argument('--arch', type=str, default='ES_CRA_ME_3', help='which architecture to use')
parser.add_argument('--grad_clip', type=float, default=5, help='gradient clipping')

args = parser.parse_args()

args.save = 'trained_model_cifar10/{}-{}'.format('robust', time.strftime("%Y%m%d-%H%M%S"))
