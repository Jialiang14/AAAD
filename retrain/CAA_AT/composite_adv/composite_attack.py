...
class CompositeAttack(nn.Module):
    def __init__(self, model, enabled_attack, mode='eval', local_rank=-1,
        ...
        self.eps_pool_cifar10 = torch.tensor(
            [(-pi, pi), (0.7, 1.3), (-10, 10), (-0.2, 0.2), (0.7, 1.3), (-8 / 255, 8 / 255)], device=self.device) #orginal provided by the authors
        # self.eps_pool_cifar10 = torch.tensor(
        #     [(-pi, pi), (0/2, 1/2), (-10, 10 ), (-0.2, 0.2), (0/2, 1/2), (-8 / 255, 8 / 255)], device=self.device)
