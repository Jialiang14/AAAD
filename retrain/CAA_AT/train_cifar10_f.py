...
# from retrain.LAS_MAT.CIFAR10_models import *
...
parser.add_argument('--model-dir', default='./MobileNetV2-f',
...
def main_worker(gpu, args):
    ...
    #     '/mnt/jfs/sunjialiang/AAAD/retrain/PGD_advtrain/advtrain_exp/eval-ResNet18-20230404-040829/weights.pt')
    # save_model_path = '/mnt/jfs/sunjialiang/AAAD/retrain/PGD_advtrain/advtrain_exp_110/eval-VGG-20230508-072252/weights.pt'
    # save_model_path = '/mnt/jfs/sunjialiang/AAAD/retrain/LAS_MAT/LAS_MP_AT/LAS_MAT_3_result/model_GoogLeNet/epochs_110/epsilon_types_3_14/attack_iters_types_1_9/step_size_types_1_4/weights.pt'
    save_model_path = '/mnt/jfs/sunjialiang/AAAD/retrain/PGD_advtrain/advtrain_exp_110/eval-MobileNetV2-20230531-031341/weights.pt'
