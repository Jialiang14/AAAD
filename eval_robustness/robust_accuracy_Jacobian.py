...
if __name__ == '__main__':
    ...
    for i in model_list:
        ...
        Jacobian_value = Jacobian(model, valid_queue)
        logging.info('Jacobian value = %f', Jacobian_value)
        Jacobian_value = Jacobian_value.cpu()
        num_list.append(Jacobian_value)
    ...
    plt.savefig('DE_Jacobian.png', bbox_inches='tight', pad_inches=0.1)
