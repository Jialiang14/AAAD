...
if __name__ == '__main__':
    ...
    # model_list = ['Random_search_weight_sharing_FGSM', 'Random_search_weight_sharing_PGD', 'Random_search_weight_sharing_natural', 'Random_search_weight_sharing_System', 'Random_search_weight_sharing_Jacobian',
    ...
    for i in model_list:
        ...
        if args.arch == 'DARTS_natural':
            save_model_path = os.path.join('/mnt/jfs/sunjialiang/AAAD/retrain/standard_train/trained_model/DARTS_natural-20221205-222941', 'weights.pt')
            ...
            save_model_path = os.path.join('/mnt/jfs/sunjialiang/AAAD/retrain/standard_train/trained_model/PCDARTS_natural-20221206-091652', 'weights.pt')
        ...
        num_list.append(Ra_clean)
        num_list1.append(utils.count_parameters_in_MB(model))
    ...
    plt.ylabel("Clean Accuracy(%)", fontsize=20)
    plt.title("Evaluation after search: Clean", fontsize=20)
    plt.xticks(fontsize=20)
    plt.yticks(fontsize=20)
    plt.legend(fontsize=14, loc='upper right')
    # plt.show()
    plt.savefig('DE_Clean.png', bbox_inches='tight', pad_inches=0.1)
