...
local_root_dir = "/mnt/jfs/sunjialiang/AAAD/optimizer_adv/BONAS/exp/" # root working directory
local_data_dir = "/mnt/jfs/sunjialiang" # data root
...
search_config = dict(
    ...
    bo_sample_num=10, # number of subnets to be selected in each BO iteration
    sample_method="random", # using random sampler or EA sampler
    if_init_samples=True, # whether use randomly selected models to initialize GCN predictor
    init_num=10,
)
