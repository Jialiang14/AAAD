...
local_root_dir = "/mnt/jfs/sunjialiang/AAAD/optimizer_adv/BONAS/nips/" # root working directory
local_data_dir = "/mnt/jfs/sunjialiang/AAAD/optimizer_adv/BONAS/nips/data" # data root
