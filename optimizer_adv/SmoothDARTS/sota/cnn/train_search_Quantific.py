...
parser.add_argument('--save', type=str, default='Hessian', help='experiment name')
...
def train(train_queue, valid_queue, model, architect, criterion, optimizer, lr, perturb_alpha, epsilon_alpha, epoch):
    ...
    for step, (input, target) in enumerate(train_queue):
        ...
        if args.evaluation == 'Jacobian':
            ...
            loss = criterion(logits, target) + jacobian_loss
            ...
            loss = criterion(logits, target) + 10 * w_regularizer
