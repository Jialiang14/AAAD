...
parser.add_argument('--save', type=str, default='Jacobian', help='experiment name')
...
def train(train_queue, valid_queue, model, architect, criterion_train, optimizer, lr):
  ...
  for step, (input, target) in enumerate(train_queue):
    ...
    jacobian_loss = 100 * reg(input, logits)
    print(jacobian_loss)
    ...
    loss = jacobian_loss + clean_loss
    Total_Jacobian = Total_Jacobian + jacobian_loss
