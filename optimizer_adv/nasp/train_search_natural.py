...
class CorruptDataset(torch.utils.data.Dataset):
  def __init__(self, transform):
    print('/mnt/share1/sunjialiang/AAAD/noise/CIFAR-10-C/' + args.evaluation + '.npy')
    images = np.load('/mnt/share1/sunjialiang/AAAD/noise/CIFAR-10-C/' + args.evaluation + '.npy')
    labels = np.load('/mnt/share1/sunjialiang/AAAD/noise/CIFAR-10-C/labels.npy')
    assert labels.min() >= 0
