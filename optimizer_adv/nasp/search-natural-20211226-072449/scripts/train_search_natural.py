...
class NaturalDataset(torch.utils.data.Dataset):
  def __init__(self, transform):
    images = np.load('/mnt/sunjialiang/AAAD/noise/fast_iamge_transfer/code/data_natural.npy')
    labels = np.load('/mnt/sunjialiang/AAAD/noise/fast_iamge_transfer/code/label_natural.npy')
    assert labels.min() >= 0
...
def main():
  ...
  train_data = NaturalDataset(transform=train_transform)
