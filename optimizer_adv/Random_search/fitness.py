...
def fit(genotype):
    ...
    parser.add_argument('--robustness', type=str, default='System', help='robustness evaluation')
    ...
    for epoch in range(args.epochs):
        ...
        _, _ = train(args, train_queue, model, criterion, optimizer)
    eps = 0.031
    if args.robustness == 'clean':
        ...
        Ra = -Jacobian(model, valid_queue)
    elif args.evaluation == 'Hessian':
        Ra = -Hessian(model, valid_queue)
    return Ra
