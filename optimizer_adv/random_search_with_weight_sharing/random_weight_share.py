    ...
    def get_eval_arch(self, rounds=None):
        ...
        for r in range(n_rounds):
            ...
            for _ in range(50):
                ...
                logging.info('objective_val: %.6f' % ppl)
...
def main(args):
    ...
    root_dir = '/mnt/jfs/sunjialiang/AAAD/optimizer_adv/random_search_with_weight_sharing/results'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--eval_only', dest='eval_only', type=int, default=1)
