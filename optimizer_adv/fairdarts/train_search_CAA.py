...
from optimizer_adv.fairdarts.model_search import Network as Network_Search
...
def main():
  ...
  model = Network_Search(args.init_channels, CIFAR_CLASSES, args.layers, criterion_train,
  ...
  for epoch in range(start_epoch, args.epochs):
    ...
    train_acc, train_obj = train(train_queue, valid_queue, model, architect, criterion_train, criterion_val, model_optimizer, arch_optimizer, epoch)
...
def train(train_queue, valid_queue, model, architect, criterion, criterion_val, model_optimizer, arch_optimizer, epoch):
  ...
  for step, (input, target) in enumerate(train_queue):
    ...
    loss_noise = criterion_val(noise_logits, target)
